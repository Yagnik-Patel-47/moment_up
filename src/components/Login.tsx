  ...
  return (
    <>
      ...
      <div className="grid place-items-center h-full p-4">
        <AnimateSharedLayout>
          <motion.div
            className="p-4 sm:px-4 flex w-full flex-col items-center md:w-1/2"
            layout
          >
            <motion.span layout>
            ...
            {!googleRes && (
              ...
              >
                ...
                <div className="p-2 bg-[#004aad] flex justify-center items-center h-full w-auto">
                  <Image
                    src="/google_logo.png"
                    alt="google"
                    width={35}
            ...
            {!googleRes && (
              <motion.div className="w-full my-2 py-4" layout>
                <Divider />
                <Typography className="absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#fff] py-2 px-4">
                  OR
                </Typography>
              </motion.div>
            )}
